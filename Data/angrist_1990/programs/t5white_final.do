...
results for nonwhites are in online appendix (see ta3nonwhite_final.do)
*/
...
local outputpath ./programs/analysis/AEJ/t5white_final
...
local neededvars	elig vietnam postvet age `labor' pwt white yob sob month `z5x'
