...
DATE: 16 Sept 2010
PROGRAMMER: S Chen
DESCRIPTION: This program generates OLS/2SLS estimates for nonwhite in online table 2
results for whites are in table 4 (see t4white_final.do)
*/
...
local outputpath ./programs/analysis/AEJ/ot2_final
