/* t2nonwhite_final.do: tabe 2 first stage, nonwhites 
...
local outputpath ./programs/analysis/AEJ/t2nonwhite_final
...
use `neededvars' if yob>=1948 & yob<=1953 & white==0 & pwt>0 ///
