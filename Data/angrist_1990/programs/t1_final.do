...
DATE: 12 sept, 2010
PROGRAMMER: S Chen
DESCRIPTION: This program generates means for variables for Angrist-Chen's Table 1 (AEJ 2010) 
*/
...
local outputpath ./programs/analysis/AEJ/t1_final
...
use `neededvars' if yob>=1950 & yob<=1952 ///
